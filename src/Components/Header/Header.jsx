...
import Iso_90012015 from '../../Assets/kalpgiri/logo.jpg'
    ...
    return (
        <>
                ...
                <div className='header-tops'>
                    <div className='container'>
                        <div className='container-child'>
                            <div>
                                <h4>Welcome to our KALPGIRI SOLAR POWER
                                </h4>
                            </div>
                            <div>
                                <ul className='header-user-menu'>
                                    <li>
                                        <IoIosCall /><a href='tel:+91 9898313985'>+91 9898313985</a>
                                        <a href='tel:+91 9662345711'>+91 9662345711</a>
                                    </li>
                                    <li>
                                        <IoMdMail />
                                        <a href='mailto:kalpgirisolarpower@gmail.com'>kalpgirisolarpower@gmail.com</a>
                                    </li>
                    ...
                    <nav className={isSticky ? 'sticky' : 'navbar'}>
                        <div className='container'>
                            ...
                            <div className={`nav-links ${isOpen ? 'open' : ''}`}>
                                <img src={glogo} width='100px' height='100px' alt='logo not available'></img>
                                <ul>
                                    <li><a href="/">Home</a></li>
            ...
            <div className='Whatsapp'>
                <ul>
                    <li>
                        <a href='https://api.whatsapp.com/send/?phone=%2B919898313985&text&type=phone_number&app_absent=0' target='_blank'><FaSquareWhatsapp style={{
                            width: '47px',
                            height: '48px',
                            color: '#25d366'
                        }} />
                                ...
                                <Menu>
                                    <div className="offcanvas-mobile-menu-wrapper">
                                        ...
                                        <div className="mobile-menu-top">
                                            <span>
                                                <b>Welcome to KALPGIRI SOLAR POWER</b>
                                            </span>
                                            {/* Start Header Top Menu */}
                                            <ul className="mobile-menu-user-menu">
                                                <li className="header-user-menu-link">
                                                    <IoIosCall />
                                                    <a href="tel:+91 9898313985" target="_blank">
                                                        <b> +91 9898313985</b>
                                                    </a>
                                                    <a href="tel:+91 9662345711" target="_blank">
                                                        <b>+91 9662345711</b>
                                                    </a>
                                                </li>
                                                <a href=""></a>
                                                <li className="header-user-menu-link">
                                                    <IoMdMail />
                                                    <a href="mailto:kalpgirisolarpower@gmail.com" target="_blank">
                                                        &nbsp;
                                                    </a>
                                                    <b> kalpgirisolarpower@gmail.com</b>
                                                </li>
