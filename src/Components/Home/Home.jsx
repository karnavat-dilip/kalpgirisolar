...
function AboutUs() {
  return (
    <div>
      <p>KALPGIRI SOLAR POWER PRIVATE LIMITED ("WEL”) was founded in 1990. It is India’s largest manufacturer of solar PV modules with the largest aggregate installed capacity of 12 GW, as of June 30, 2023 (Source: CRISIL Report).
...
function OurService() {
  return (
    <div>
      <p>Deesa Solar has been a life-enriching solution for many decades and we are constantly striving to provide possible and quality solutions that build trust with millions of people.<a href='/about' style={{ color: '#01a875' }}>Read more...</a></p>
    </div>
  );
}
        ...
        <section data-aos="fade-up">
          <div className='container'>
            <div className='h1-container'>
              <h1>Welcome to KALPGIRI SOLAR POWER
              </h1>
            </div>
            <div className='intro'>
              <div className='d-flex'>
                <div>
                  ...
                  <p> Explore the way to use the Sun Energy efficiently and Free of Cost with us. Let's be a solar family. Our Mission & Vission Infinite of bringing a solar revolution by switching the mode of energy towards the solar. </p>
                </div>
                <div>
              ...
              <div>
                ...
                <p>Envisaging KALPGIRI as a leading brand of solar products meant for all the age groups and all the sectors of your life. Be it domestic, industrial, and institutional.</p>
              </div>
            </div>
          </div>
        </section>
