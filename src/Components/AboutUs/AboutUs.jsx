...
function About() {
    return (
        <div>
            <p>KALPGIRI SOLAR POWER PRIVATE LIMITED ("WEL”) was founded in 1990. It is India’s largest manufacturer of solar PV modules with the largest aggregate installed capacity of 12 GW, as of June 30, 2023 (Source: CRISIL Report).</p>
        </div>
    );
}
...
function OurService() {
    return (
        <div>
            <p>Deesa Solar has been a life-enriching solution for many decades and we are constantly striving to provide possible and quality solutions that build trust with millions of people.</p>
        </div>
    );
}
function AboutUs() {
                ...
                <div className='container'>
                    <div className='about-container'>
                        ...
                        <div className='second-child' data-aos="fade-up">
                            <h1>Welcome To KALPGIRI SOLAR POWER</h1>
                            <p>KALPGIRI SOLAR POWER (P) LIMITED has been serving with its world-class domestic,institutional and industrial solar solutions across the world. Explore the way to use the Sun Energy efficiently and Free of Cost with us. Let's be a solar family. Our Mission & Vission Infinite of bringing a solar revolution by switching the mode of energy towards the solar. Envisaging KALPGIRI as a leading brand of solar products meant for all the age groups and all the sectors of your life.</p>
                        </div>
                        {/* <div data-aos="fade-up">
                        ...
                        <div className='second-child' data-aos="fade-up">
                            <h1>Why KALPGIRI SOLAR POWER ?</h1>
                            <div>
